...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  A Relational Database is the actual database while sql is used to interact with it.

- [ ] Why do tables need a `primary key`?

  So that tables have a unique way of identifying everything
...
- [ ] What do we need in order to have a _many to many_ relationship between two tables.
  ...
  A separate table that holds foreign keys to each
